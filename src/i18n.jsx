...
const T = {
  es: {
    bm_add:          "Marcar línea (Space)",
    bm_remove:       "Quitar marcador (Space)",
    ...
    time_filter_btn: "Hora",
    time_filter_title:"Filtrar por día y rango de hora.",
    time_date_title: "Día del log; si no eliges uno, se usa hoy para horas sin fecha",
    time_date_today: "Hoy / sin día",
    time_from_ph:    "desde 09:20:10",
    time_to_ph:      "hasta",
    time_input_title:"Usa sólo hora: HH:mm:ss",
    time_clear_btn:  "Restablecer",
    time_clear_title:"Restablecer rango de tiempo",
    match_prev_title:"Resultado anterior",
    match_next_title:"Resultado siguiente",
    match_source_filter:"Filtro",
    match_source_search:"Búsqueda",
    ...
    autoscroll_btn:  "↓ anclar al final",
  ...
  en: {
    bm_add:          "Bookmark line (Space)",
    bm_remove:       "Remove bookmark (Space)",
    ...
    time_filter_title:"Filter by day and time range.",
    time_date_title: "Log day; when none is selected, time-only log lines use today",
    time_date_today: "Today / no day",
    time_from_ph:    "from 09:20:10",
    time_to_ph:      "to",
    time_input_title:"Use time only: HH:mm:ss",
    time_clear_btn:  "Reset",
    time_clear_title:"Reset time range",
    match_prev_title:"Previous match",
    match_next_title:"Next match",
    match_source_filter:"Filter",
...
const GUIDE = {
  es: [
    ...
    { title:"Filtrar y buscar", items:[
      ...
      "Hora permite elegir un día detectado en el log y capturar sólo horas; si no hay día elegido, las horas sin fecha usan hoy.",
    ...
    { title:"Marcadores y selección", items:[
      "Clic en ◇ junto al número de línea, o Space con una línea activa, la marca o desmarca.",
    ...
    { title:"Seguir en vivo (tail -f)", items:[
      ...
      "«Limpiar» borra sólo la vista actual para mostrar lo nuevo desde ese momento; «Recargar» vuelve a leer desde el origen.",
    ]},
    ...
    { title:"Configuración y diagnóstico", items:[
      "Idioma, tema (incluye «Brasa» y «Azul»), archivos recientes y preferencias por defecto.",
  ...
  en: [
    ...
    { title:"Filtering and search", items:[
      ...
      "Time lets you choose a day detected in the log and enter time-only ranges; without a selected day, time-only lines use today.",
    ...
    { title:"Bookmarks and selection", items:[
      "Click ◇ next to the line number, or Space with an active line, to bookmark or unbookmark it.",
    ...
    { title:"Live tail (tail -f)", items:[
      ...
      "“Clear” only clears the current view so new lines start fresh; “Reload” rereads from the source.",
    ]},
    ...
    { title:"Settings and diagnostics", items:[
      "Language, theme (including “Ember” and “Blue”), recent files, and default preferences.",
...
const GUIDE_SHORTCUTS = {
  es: [
    ...
    ["F2 / Shift+F2", "Marcador siguiente / anterior"], ["Space", "Marcar/desmarcar línea seleccionada"],
  ...
  en: [
    ...
    ["F2 / Shift+F2", "Next / previous bookmark"], ["Space", "Bookmark/unbookmark selected line"],
